...
func TestPhase3b_NoCellImplementsContributor(t *testing.T) {
	plain := &plainCellForLC{BaseCell: *cell.NewBaseCell(&metadata.CellMeta{ID: "plain"})}
...
func TestPhase3b_EmptySliceContributor(t *testing.T) {
	lc := &lcCell{
		BaseCell: *cell.NewBaseCell(&metadata.CellMeta{ID: "mycell"}),
...
func TestPhase3b_DuplicateHookName_FailFast(t *testing.T) {
	cellA := &lcCell{
		BaseCell: *cell.NewBaseCell(&metadata.CellMeta{ID: "cellA"}),
		hooks: []cell.LifecycleHook{
			{Name: "shared.hook", OnStart: func(_ context.Context) error { return nil }},
		},
	}
	cellB := &lcCell{
		BaseCell: *cell.NewBaseCell(&metadata.CellMeta{ID: "cellB"}),
		hooks: []cell.LifecycleHook{
			{Name: "shared.hook", OnStart: func(_ context.Context) error { return nil }},
		},
	}
...
func TestPhase3b_OneCellTwoHooks(t *testing.T) {
	...
	lc := &lcCell{
		BaseCell: *cell.NewBaseCell(&metadata.CellMeta{ID: "mycore"}),
		hooks:    hooks,
	}
	asm := buildAsmStarted(t, lc)
...
func TestPhase3b_TwoCellsOrderPreserved(t *testing.T) {
	lcA := &lcCell{
		BaseCell: *cell.NewBaseCell(&metadata.CellMeta{ID: "alpha"}),
		hooks:    []cell.LifecycleHook{{Name: "alpha-hook", OnStart: func(_ context.Context) error { return nil }}},
	}
	lcB := &lcCell{
		BaseCell: *cell.NewBaseCell(&metadata.CellMeta{ID: "beta"}),
