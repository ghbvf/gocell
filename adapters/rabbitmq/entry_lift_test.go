...
// nil Settlement. Adapter-layer tests call Subscriber.Subscribe directly and
// do not need ConsumerBase idempotency or business middleware — nil Settlement
// is safe because the subscriber nil-checks before calling Commit/Release.
//
