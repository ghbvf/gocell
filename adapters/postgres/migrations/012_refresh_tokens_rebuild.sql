...
-- permit at the Migrator.Down API boundary, then start the old binary after
-- the DB schema is back at 011. Never run new and old binaries against the
-- opposite refresh_tokens schema.
--
