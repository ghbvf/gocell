...
type Service struct {
	roleRepo ports.RoleRepository `gocell:"required" gocellKind:"KindInvalid" gocellCode:"ErrValidationFailed" gocellErr:"authorizationdecide: roleRepo is required"`
	logger   *slog.Logger
}
