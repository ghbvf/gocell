...
const (
	...
	// sessionIDPrefix is the prefix applied to every session ID generated by
	// this slice. Kept as a single constant so Login and IssueForUser stay in
	// lockstep when the format needs to evolve.
