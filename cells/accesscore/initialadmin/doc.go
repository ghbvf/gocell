...
// password is generated, written to a platform-restricted credential file,
// assigned to a new admin user with password_reset_required=true, and a
// TTL-bounded cleaner worker removes the file after the configured TTL.
//
// # Consistency level
//
