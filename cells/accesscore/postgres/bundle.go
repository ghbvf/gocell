...
// consumed by cells/accesscore.WithPGBundle) so composition roots cannot
// accidentally pair primitives from different pools or substitute a non-PG
// SetupLock.
//
// See cells/accesscore/mem.Bundle godoc for the upstream-Hard / downstream-Hard
...
// TxRunner) quadruple. Fields are unexported; cells/accesscore.WithPGBundle
