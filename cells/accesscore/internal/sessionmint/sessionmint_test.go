...
func TestMintAccess_Success(t *testing.T) {
	...
	res, err := MintAccess(context.Background(), clock.Real(), deps, req)
	require.NoError(t, err)
...
func TestMintAccess_JTI_UniquePerCall(t *testing.T) {
	...
	r1, err := MintAccess(context.Background(), clock.Real(), deps, req)
	require.NoError(t, err)
	r2, err := MintAccess(context.Background(), clock.Real(), deps, req)
	require.NoError(t, err)
...
func TestMintAccess_DeterministicClock(t *testing.T) {
	...
	res, err := MintAccess(context.Background(), clockmock.New(fixed), deps, req)
	require.NoError(t, err)
