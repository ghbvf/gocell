...
type Service struct {
	...
	txRunner persistence.CellTxManager `gocell:"required" gocellKind:"KindInvalid" gocellCode:"ErrValidationFailed" gocellErr:"configpublish: TxRunner required; use WithTxManager"` //nolint:lll // R2-approved: gocell tag overrides are machine-readable and must stay on one line
