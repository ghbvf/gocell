...
- STATUS-BOARD-LIFECYCLE-CONSISTENCY: `validateJOURNEYSTATUSLIFECYCLE01` `validBoardLifecycleMatrix` 三态强映射（todo→{experimental} / doing→{experimental,active} / done→{active,stable}）+ active+doing Warning（in-transit reminder, 非阻断）
