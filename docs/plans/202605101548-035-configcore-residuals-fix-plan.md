...
| **PR-CFG-L2-DIVERGENCE** | ConfigCore L2 与 memory 行为分歧治理 | #5 | Cx1（决策）+ Cx2（实施） | 1d 设计 + 4h 实施 | 🟡 候选 (a) durabilityMode 已 RETRACTED（#556→#559）；本体转 backlog `BASECELL-DURABILITYMODE-RUNTIME-ALIGNMENT-DEFERRED`，(b)/(c) 待决 |
