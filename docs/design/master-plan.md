...
authoritativeData: [users, roles, sessions, refresh_tokens]
contracts:
  produces:
...
ownedSlices:
  ...
  - config-subscribe
  - feature-flag
authoritativeData: [config_entries, config_versions, config_namespaces]
contracts:
  produces:
    - event.config.changed.v1
    - event.config.rollback.v1
