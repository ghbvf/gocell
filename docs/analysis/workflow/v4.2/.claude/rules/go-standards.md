...
详见 docs/architecture/metadata-schemas.md
...
- owner: 负责人
- ownedSlices: 拥有的 Slice 列表
- authoritativeData: 权威数据声明
- contracts: 发布/消费的契约列表
- verify: 验证命令
...
- consistencyLevel: L0-L4
- journeys: 关联的 Journey 列表
- verify: 验证命令
- allowedFiles: 允许的文件列表
