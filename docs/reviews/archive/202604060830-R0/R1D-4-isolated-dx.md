...
Scope: `adapters/oidc/*` plus the current config/integration docs that describe its public surface. I did not read or reuse any existing review/report file under `docs/reviews/`.
...
Evidence:
- [`adapters/oidc/config.go:31`](/Users/shengming/Documents/code/gocell/adapters/oidc/config.go:31)
- [`adapters/oidc/config.go:43`](/Users/shengming/Documents/code/gocell/adapters/oidc/config.go:43)
- [`adapters/oidc/provider.go:38`](/Users/shengming/Documents/code/gocell/adapters/oidc/provider.go:38)
- [`adapters/oidc/token.go:38`](/Users/shengming/Documents/code/gocell/adapters/oidc/token.go:38)
- [`adapters/oidc/verifier.go:57`](/Users/shengming/Documents/code/gocell/adapters/oidc/verifier.go:57)
- [`adapters/oidc/verifier.go:67`](/Users/shengming/Documents/code/gocell/adapters/oidc/verifier.go:67)
...
Evidence:
- [`adapters/oidc/config.go:19`](/Users/shengming/Documents/code/gocell/adapters/oidc/config.go:19)
- [`adapters/oidc/config.go:21`](/Users/shengming/Documents/code/gocell/adapters/oidc/config.go:21)
- [`adapters/oidc/provider.go:44`](/Users/shengming/Documents/code/gocell/adapters/oidc/provider.go:44)
- [`adapters/oidc/provider.go:57`](/Users/shengming/Documents/code/gocell/adapters/oidc/provider.go:57)
- [`adapters/oidc/verifier.go:155`](/Users/shengming/Documents/code/gocell/adapters/oidc/verifier.go:155)
- [`adapters/oidc/verifier.go:226`](/Users/shengming/Documents/code/gocell/adapters/oidc/verifier.go:226)
- [`adapters/oidc/token.go:26`](/Users/shengming/Documents/code/gocell/adapters/oidc/token.go:26)
