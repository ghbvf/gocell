...
- 日期：2026-04-05
- 审查对象：`src/`
- 审查计划：[`docs/architecture/code-review-baseline-plan.md`](./202604050000-021-code-review-baseline-plan.md)
- 最终结论：`blocked`
...
- 顶层 [`src/gocell.go`](../../src/gocell.go) 仍直接泄漏 assembly 级别细节，API 过薄
...
- [`src/kernel/slice/verify.go`](../../src/kernel/slice/verify.go) 的执行路径未真正成为 metadata-governed 的 CLI 主路径
...
- [`src/cmd/core-bundle/main.go`](../../src/cmd/core-bundle/main.go) 仍是空 stub；空 stub 本身不是 bug，但它与文档和生成链路一起会制造错误预期
...
- [`src/assemblies/core-bundle/generated/boundary.yaml`](../../src/assemblies/core-bundle/generated/boundary.yaml) 明显陈旧、占位化且不可信
...
- [`src/cmd/gocell/validate.go`](../../src/cmd/gocell/validate.go)
- [`src/contracts/http/auth/me/v1/contract.yaml`](../../src/contracts/http/auth/me/v1/contract.yaml)
- [`src/contracts/http/config/flags/v1/contract.yaml`](../../src/contracts/http/config/flags/v1/contract.yaml)
- [`src/cells/access-core/slices/session-refresh/slice.yaml`](../../src/cells/access-core/slices/session-refresh/slice.yaml)
- [`src/cells/config-core/slices/config-subscribe/slice.yaml`](../../src/cells/config-core/slices/config-subscribe/slice.yaml)
...
- [`src/cmd/gocell/verify.go`](../../src/cmd/gocell/verify.go)
- [`src/cmd/gocell/check.go`](../../src/cmd/gocell/check.go)
- [`src/cmd/gocell/generate.go`](../../src/cmd/gocell/generate.go)
- [`src/cmd/gocell/main_test.go`](../../src/cmd/gocell/main_test.go)
- [`src/assemblies/core-bundle/assembly.yaml`](../../src/assemblies/core-bundle/assembly.yaml)
- [`src/cmd/core-bundle/main.go`](../../src/cmd/core-bundle/main.go)
- [`src/assemblies/core-bundle/generated/boundary.yaml`](../../src/assemblies/core-bundle/generated/boundary.yaml)
...
- [`src/kernel/metadata/parser.go`](../../src/kernel/metadata/parser.go)
- [`src/kernel/metadata/schemas/embed.go`](../../src/kernel/metadata/schemas/embed.go)
...
- [`src/kernel/governance/rules_verify.go`](../../src/kernel/governance/rules_verify.go)
- [`src/kernel/governance/rules_ref.go`](../../src/kernel/governance/rules_ref.go)
- [`src/kernel/governance/rules_topo.go`](../../src/kernel/governance/rules_topo.go)
- [`src/kernel/governance/targets.go`](../../src/kernel/governance/targets.go)
- [`src/kernel/slice/verify.go`](../../src/kernel/slice/verify.go)
...
- [`src/kernel/assembly/assembly.go`](../../src/kernel/assembly/assembly.go)
- [`src/kernel/cell/base.go`](../../src/kernel/cell/base.go)
- [`src/kernel/outbox/outbox.go`](../../src/kernel/outbox/outbox.go)
- [`src/kernel/idempotency/idempotency.go`](../../src/kernel/idempotency/idempotency.go)
- [`src/gocell.go`](../../src/gocell.go)
...
- [`src/cells/access-core/cell.yaml`](../../src/cells/access-core/cell.yaml)
