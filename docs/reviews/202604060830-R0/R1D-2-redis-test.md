...
| Scope | `src/adapters/redis/` plus direct integration usage |
...
- Files: `src/adapters/redis/distlock.go:117-126`, `src/adapters/redis/distlock_test.go:12-129`
...
- Files: `src/adapters/redis/distlock.go:96-99`, `src/adapters/redis/distlock.go:136-139`, `src/adapters/redis/integration_test.go:100-125`
...
- Files: `src/adapters/rabbitmq/consumer_base.go:102-123`, `src/tests/integration/outbox_fullchain_test.go:299-333`
