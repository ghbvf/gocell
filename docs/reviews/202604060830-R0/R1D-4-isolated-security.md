...
Evidence:
- `src/adapters/oidc/provider.go:71-123`
- `src/adapters/oidc/token.go:28-47`
- `src/adapters/oidc/userinfo.go:25-43`
- `src/adapters/oidc/verifier.go:179-197`
...
Evidence:
- `src/adapters/oidc/provider.go:44-52`
- `src/adapters/oidc/provider.go:71-79`
- `src/adapters/oidc/token.go:46-54`
- `src/adapters/oidc/userinfo.go:36-43`
- `src/adapters/oidc/config.go:43-51`
...
Evidence:
- `src/adapters/oidc/config.go:21-24,37-39`
- `src/adapters/oidc/verifier.go:48-55`
- `src/adapters/oidc/verifier.go:155-177`
- `src/adapters/oidc/verifier.go:226-251`
- `src/adapters/oidc/verifier.go:230`
...
Evidence:
- `src/adapters/oidc/verifier.go:65-135`
