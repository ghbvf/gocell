...
| R-03 | **BOOTSTRAP-NIL-OPTION-CONSISTENCY** — `WithManagedCloser(nil)` 静默接受，`WithManagedResource(nil)` phase0 fail-fast — 相邻 API 风格冲突；修复: 两者均改 fail-fast | bug | P2/Cx1 | 🟡 | — | `runtime/bootstrap/options.go` | 030 §2 R-03 |
