...
| P1-8 | **FEAT-1 DEVICE-LIST-API**: 新建 `device-list` slice + `GET /api/v1/devices` 分页 + contract + contract_test；同步触发 CONTRACT-LIST-LINT-01 规则 | 3h | `cells/devicecell/slices/device-list/` + `contracts/http/device/list/v1/` | backend_issues.md #1 |
