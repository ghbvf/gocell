...
archtest `ASSERTION-CTOR-01` 拦截非豁免文件中出现的裸 `panic`（排除 recover 块内 re-throw）。
...
- `.claude/rules/gocell/error-handling.md` §4-6（MESSAGE-CONST-LITERAL-01 / ASSERTION-CTOR-01 / DETAILS-SLOG-ATTR-01）
