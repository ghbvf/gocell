...
| `CODEGEN-CONTRACT-GEN-01` | `codegen_invariants_test.go` | 248 | codegen |
| `CODEGEN-CONTRACT-GEN-01` | `patch_optional_bool_pointer_test.go` | 68 | codegen |
| `COMMAND-PROJECTION-EXPLICIT-01` | `codegen_invariants_test.go` | 407 | command |
...
| `NO-METADATA-LITERAL-IN-CELLGO-01` | `codegen_invariants_test.go` | 552 | no |
...
| `SPEC-GEN-TOPIC-EQUALS-CONTRACT-ID-01` | `codegen_invariants_test.go` | 727 | codegen |
