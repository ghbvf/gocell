...
| `ASSEMBLY-CELLMODULE-TYPE-04` | `assembly_invariants_test.go` | 357 | assembly |
| `ASSEMBLY-MAXCONSISTENCY-DERIVED-03` | `assembly_invariants_test.go` | 255 | assembly |
| `ASSEMBLY-MODULES-GEN-01` | `assembly_invariants_test.go` | 86 | assembly |
| `ASSEMBLY-MODULES-SWITCH-FORBIDDEN-02` | `assembly_invariants_test.go` | 188 | assembly |
| `ASSEMBLY-SNAPSHOTS-LOCKED-01` | `assembly_invariants_test.go` | 459 | assembly |
| `ASSEMBLYREF-METHOD-SET-01` | `assembly_invariants_test.go` | 1041 | assembly |
...
| `CODEGEN-CONTRACT-GEN-01` | `codegen_invariants_test.go` | 242 | codegen |
| `CODEGEN-CONTRACT-GEN-01` | `patch_optional_bool_pointer_test.go` | 68 | codegen |
| `CODEGEN-CONTRACT-GEN-02` | `codegen_invariants_test.go` | 243 | codegen |
| `CODEGEN-CONTRACT-USER-OVERLAP-01` | `codegen_invariants_test.go` | 244 | codegen |
| `COMMAND-PROJECTION-EXPLICIT-01` | `codegen_invariants_test.go` | 383 | command |
...
| `EVENT-DTO-CAMELCASE-01` | `event_camelcase_test.go` | 70 | event |
...
| `MARKER-MISSING-FOR-WIRE-CALL-01` | `codegen_invariants_test.go` | 528 | marker |
| `MARKER-WIRE-SINGLE-SOURCE-01` | `codegen_invariants_test.go` | 530 | marker |
| `MARKERGEN-DRIFT-VERIFY-01` | `codegen_invariants_test.go` | 529 | markergen |
...
| `METADATA-LIMITS-SINGLE-SOURCE-01` | `outbox_invariants_test.go` | 1637 | metadata |
| `MIGRATION-NO-TRANSACTION-RERUN-SAFE-01` | `migration_no_transaction_rerun_safe_test.go` | 12 | migration |
...
| `NO-METADATA-LITERAL-IN-CELLGO-01` | `codegen_invariants_test.go` | 526 | no |
| `NO-TEST-SERVICE-CONTEXT-IN-PRODUCTION-01` | `no_test_service_context_in_production_test.go` | 1 | no |
| `NO-WIRE-FIELDS-IN-YAML-01` | `codegen_invariants_test.go` | 527 | no |
| `OBS-01` | `observability_metrics_test.go` | 12 | obs |
| `OUTBOX-CELL-01` | `outbox_invariants_test.go` | 62 | outbox |
| `OUTBOX-HANDLERESULT-NO-RECEIPT-FIELD-01` | `outbox_invariants_test.go` | 592 | outbox |
...
| `OUTBOX-METADATA-MAX-BYTES-01` | `outbox_invariants_test.go` | 344 | outbox |
| `OUTBOX-PAYLOAD-SIZE-01` | `outbox_invariants_test.go` | 464 | outbox |
| `OUTBOX-RELAY-LOST-METRIC-01` | `outbox_invariants_test.go` | 653 | outbox |
| `OUTBOX-RELAY-LOST-METRIC-01` | `outbox_invariants_test.go` | 735 | outbox |
| `OUTBOX-SERVICE-01` | `outbox_invariants_test.go` | 811 | outbox |
| `OUTBOX-SERVICE-02` | `outbox_invariants_test.go` | 812 | outbox |
| `OUTBOX-SERVICE-03` | `outbox_invariants_test.go` | 813 | outbox |
| `OUTBOX-SERVICE-04` | `outbox_invariants_test.go` | 814 | outbox |
| `OUTBOX-SERVICE-05` | `outbox_invariants_test.go` | 815 | outbox |
| `OUTBOX-TOPIC-FAILOPEN-01` | `outbox_invariants_test.go` | 1245 | outbox |
| `OUTBOX-TOPIC-FAILOPEN-01` | `outbox_invariants_test.go` | 1461 | outbox |
...
| `SEC-FAIL-CLOSED-02` | `security_defaults_test.go` | 51 | sec |
| `SEC-FAIL-CLOSED-03` | `security_defaults_test.go` | 52 | sec |
| `SEC-FAIL-CLOSED-04` | `security_defaults_test.go` | 53 | sec |
| `SEC-FAIL-CLOSED-05` | `security_defaults_test.go` | 54 | sec |
| `SEC-FAIL-CLOSED-06` | `security_defaults_test.go` | 55 | sec |
| `SEC-FAIL-CLOSED-07` | `security_defaults_test.go` | 56 | sec |
| `SEC-FAIL-CLOSED-08` | `security_defaults_test.go` | 57 | sec |
| `SEC-FAIL-CLOSED-09` | `security_defaults_test.go` | 58 | sec |
...
| `SPEC-GEN-TOPIC-EQUALS-CONTRACT-ID-01` | `codegen_invariants_test.go` | 700 | codegen |
| `SPEC-GEN-VALUE-PARITY-01` | `codegen_invariants_test.go` | 384 | codegen |
...
| `rules_misc_consistency.go` | CONTRACT-CONSISTENCY-EMIT-01 |
