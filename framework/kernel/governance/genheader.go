...
// .yaml, .ts); any future generator producing a different extension must
// extend this filter alongside the generator change so reverse enumeration
// stays closed.
//
// TypeScript files (*.ts) emitted by contractgen use the Go-style
// "// Code generated by gocell generate " prefix (valid TS line comment),
// so they match the GoGeneratedPrefix sentinel check.
//
