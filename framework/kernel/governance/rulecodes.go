...
const (
	...
	codeCELLLIFECYCLE01           RuleCode = "CELL-LIFECYCLE-01"
	...
	codeSAGACONTRACTSTEPNAMEVALID01     RuleCode = "SAGA-CONTRACT-STEP-NAME-VALID-01"
	codeSAGACONTRACTSTEPNAMEUNIQUE01    RuleCode = "SAGA-CONTRACT-STEP-NAME-UNIQUE-01"
	codeSAGACONTRACTSTEPSCHEMAREF01     RuleCode = "SAGA-CONTRACT-STEP-SCHEMA-REF-01"
	codeSAGACONTRACTCOMPENSATIONORDER01 RuleCode = "SAGA-CONTRACT-COMPENSATION-ORDER-01"
	codeSAGACONTRACTCONSISTENCYL301     RuleCode = "SAGA-CONTRACT-CONSISTENCY-L3-01"
	codeSAGACONTRACTRETRYTIMEOUT01      RuleCode = "SAGA-CONTRACT-RETRY-TIMEOUT-01"
	codeSAGACELLLEVELL3DECLARE01        RuleCode = "SAGA-CELL-LEVEL-L3-DECLARE-01"
