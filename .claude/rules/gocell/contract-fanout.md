...
|---|---|---|
| **IMPL-DECL-COVER-01** | impl → contract | `corecells/<A>` 生产代码禁止直接 import `corecells/<B>`（不同 cell），跨 cell 通信必须经 contract；唯一例外是 `corecells/<B>/<B>test/*` 公开测试 helper |
| **HANDLER-DECL-COVER-01** | impl → contract | `corecells/*` / `examples/*` 中实现了 `generated/contracts/http/.../Service` 接口的具体类型，必须在对应 contract.yaml 存在且 `lifecycle: active`（无孤儿 impl） |
...
> 或修改 `corecells/*/slices/*/` 下的接口实现，都可能触发上述 invariant 红灯。
