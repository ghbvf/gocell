...
// Source: corecells/registrycore/slices/registrywrite/slice.yaml
...
var sliceMeta = &metadata.SliceMeta{
	...
	ContractUsages: []metadata.ContractUsage{
		{Contract: "http.registry.contract.submit.v1", Role: "serve"},
	},
	Verify: metadata.SliceVerifyMeta{
		Unit: []string{
			"unit.registrywrite.service",
		},
		Contract: []string{
			"contract.http.registry.contract.submit.v1.serve",
		},
	},
	AllowedFiles: []string{
		"corecells/registrycore/slices/registrywrite/**",
	},
}
