...
// generated request field; rejects missing, malformed, or
...
func (a InternalGetAdapter) Get(ctx context.Context, req *internalapig.Request) (internalapig.GetResponseObject, error) {
	t, err := tenant.ParseTenantID(req.XTenantID)
	if err != nil {
...
// mounts it on the InternalListener (see corecells/configcore/cell.go marker).
type Handler struct {
