...
//
// This package is intentionally outside corecells/configcore's root package so the
...
// counter without exposing Prometheus types through corecells/configcore.
