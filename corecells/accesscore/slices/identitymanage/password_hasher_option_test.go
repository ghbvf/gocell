...
// TestWithPasswordHasher_SetsAndIgnoresNil covers the identity-manage option: a
// non-nil hasher replaces the default; a typed-nil input is ignored
// (builder-noop) so the production default survives.
