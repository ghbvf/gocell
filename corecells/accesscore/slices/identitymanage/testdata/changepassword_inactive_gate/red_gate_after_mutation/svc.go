...
//
// LOCATION RATIONALE: imports corecells/accesscore/internal/credentialauthority, so
// Go's internal-import rule requires this fixture under corecells/accesscore/.
