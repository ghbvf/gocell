...
// corecells/accesscore/internal/ports.UserRepository so the archtest's
// type-aware scanner resolves the receiver to that exact package. Go's
// internal-import rule rejects this from anywhere outside corecells/accesscore/,
// which is why this fixture lives under corecells/accesscore/internal/.../testdata
