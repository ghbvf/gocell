...
// external packages from importing corecells/accesscore/internal/ports (the real
// UserRepository / RoleRepository / ConfigGetter interfaces) or
// corecells/accesscore/internal/domain (the User / Role aggregates). This
// package lives inside the corecells/accesscore subtree, so it can import those
...
// never need to import any corecells/accesscore/internal/* package.
//
...
// public API forces callers to import corecells/accesscore/internal/*.
//
// # Relationship to cell.go composition root
//
// corecells/accesscore/cell.go is the production composition root: it wires real
...
//
// corecells/accesscore/mem.NewBundle is the sealed funnel that vends all four
...
// for all corecells/{X}/{X}test packages.
//
...
// not force its consumers to import corecells/accesscore/internal/* — is gated
