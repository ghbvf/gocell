...
// field names here rather than importing corecells/accesscore/internal/dto.
...
// ref: corecells/accesscore/internal/dto/session_events.go SessionCreatedEvent (same field names).
