...
// corecells/auditcore/internal/. This package exports the wiring that the
// integration tests previously duplicated inline, making it reusable across
// criterion test files.
//
// # Import scope
//
// auditcoretest is a sibling package inside the corecells/auditcore subtree.
// It may import corecells/auditcore/* (including internal sub-packages) because
...
//
// # Relationship to corecells/auditcore/cell.go
//
...
// depguard blocks testify imports in non-_test.go files under corecells/. The
