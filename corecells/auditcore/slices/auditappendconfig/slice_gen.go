...
// Source: corecells/auditcore/slices/auditappendconfig/slice.yaml
...
var sliceMeta = &metadata.SliceMeta{
	...
	ContractUsages: []metadata.ContractUsage{
		...
		{Contract: "event.config.entry-upserted.v1", Role: "subscribe", Handler: "HandleEvent"},
		{Contract: "event.config.entry-deleted.v1", Role: "subscribe", Handler: "HandleEvent"},
		{Contract: "event.config.version-published.v1", Role: "subscribe", Handler: "HandleEvent"},
		{Contract: "event.config.rollback.v1", Role: "subscribe", Handler: "HandleEvent"},
	},
