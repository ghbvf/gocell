...
func TestLocator_ConventionalDiscover(t *testing.T) {
	fsys := fstest.MapFS{
		...
		"corecells/configcore/cell.yaml":                      &fstest.MapFile{Data: []byte("id: configcore\n")},
		"corecells/configcore/slices/configread/slice.yaml":   &fstest.MapFile{Data: []byte("id: configread\n")},
	...
	want := []string{
		...
		"cell:corecells/configcore/cell.yaml:configcore",
		...
		"slice:corecells/configcore/slices/configread/slice.yaml:configcore",
