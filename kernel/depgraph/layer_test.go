...
func TestClassifier_Layer(t *testing.T) {
	...
	tests := []struct {
		...
		{"corecells", testModule + "/corecells/accesscore", LayerCells},
		{"corecells_slice", testModule + "/corecells/accesscore/slices/sessionlogin", LayerCells},
...
func TestClassifier_Cell(t *testing.T) {
	...
	tests := []struct {
		...
		{"corecell_root", testModule + "/corecells/accesscore", "accesscore"},
		{"corecell_internal", testModule + "/corecells/accesscore/internal/domain", "accesscore"},
		{"corecell_slice", testModule + "/corecells/auditcore/slices/journal", "auditcore"},
		{"cells_dir_only", testModule + "/cells", ""},
		{"corecells_dir_only", testModule + "/corecells", ""},
		{"shared_internal_helper", testModule + "/cells/internal/testoutbox", ""},
		{"corecells_shared_internal_helper", testModule + "/corecells/internal/testoutbox", ""},
		{"stdlib", "fmt", ""},
...
func TestClassifier_Slice(t *testing.T) {
	...
	tests := []struct {
		...
		{"corecell_slice_root", testModule + "/corecells/accesscore/slices/sessionlogin", "sessionlogin"},
		{"corecell_slice_nested", testModule + "/corecells/accesscore/slices/sessionlogin/handlers", "sessionlogin"},
		{"cell_root_no_slice", testModule + "/cells/accesscore", ""},
		{"corecell_root_no_slice", testModule + "/corecells/accesscore", ""},
		{"cell_internal_no_slice", testModule + "/cells/accesscore/internal/domain", ""},
		{"corecell_internal_no_slice", testModule + "/corecells/accesscore/internal/domain", ""},
...
func TestClassifier_MultiModule(t *testing.T) {
	...
	tests := []struct {
		...
		{"core_corecell", core + "/corecells/accesscore", core, LayerCells, "accesscore", ""},
		{"core_corecell_slice", core + "/corecells/accesscore/slices/sessionlogin", core, LayerCells, "accesscore", "sessionlogin"},
