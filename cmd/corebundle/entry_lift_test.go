...
// nil Settlement. Tests call Subscriber.Subscribe directly and do not need
// ConsumerBase idempotency — nil Settlement is safe because the subscriber
// nil-checks before calling Commit/Release.
//
