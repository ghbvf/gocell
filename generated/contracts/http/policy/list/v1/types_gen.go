...
// Request — http.policy.list.v1.request
type Request struct {
	Cursor string `json:"cursor,omitempty"`
	Limit  int64  `json:"limit,omitempty"`
}

// Response — http.policy.list.v1.response
...
type ResponseDataItemRulesItem struct {
	ID          string                                     `json:"id"`
	Name        string                                     `json:"name"`
...
type ResponseDataItemRulesItemObligations struct {
	RowScope  string   `json:"rowScope,omitempty"`
	FieldMask []string `json:"fieldMask,omitempty"`
}

// ListResponseObject is the typed response envelope for
// http.policy.list.v1. Service.List must return one of the
...
func (r List200JSONResponse) visitListResponse(ctx context.Context, w http.ResponseWriter) error {
	...
	if err := json.NewEncoder(&buf).Encode(Response(r)); err != nil {
		...
		slog.ErrorContext(ctx, "http.policy.list.v1: encode List200JSONResponse body", attrs...)
		return err
	}
