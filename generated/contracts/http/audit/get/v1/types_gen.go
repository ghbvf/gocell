...
// source: contracts/http/audit/get/v1/contract.yaml
...
// Request — http.audit.get.v1.request
type Request struct {
	ID string `json:"id"`
}

// Response — http.audit.get.v1.response
type Response struct {
	Data projection.ResourceProjection `json:"data"`
}

// ResponseData is a generated DTO for contract http.audit.get.v1.
...
// http.audit.get.v1. Service.Get must return one of the
...
func (r Get200JSONResponse) visitGetResponse(ctx context.Context, w http.ResponseWriter) error {
	...
	if err := json.NewEncoder(&buf).Encode(Response(r)); err != nil {
		...
		slog.ErrorContext(ctx, "http.audit.get.v1: encode Get200JSONResponse body", attrs...)
		return err
	}
