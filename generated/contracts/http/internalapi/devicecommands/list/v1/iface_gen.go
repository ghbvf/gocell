...
// Service is the business interface that the http.internal.devicecommands.list.v1 server cell must implement.
//
...
//     List{Status}{Suffix} structs (each implements
//     ListResponseObject declared in types_gen.go).
...
type Service interface {
	List(ctx context.Context, req *Request) (ListResponseObject, error)
}
