...
// Service is the business interface that the http.devicestate.v1 server cell must implement.
//
...
//     Devicestate{Status}{Suffix} structs (each implements
//     DevicestateResponseObject declared in types_gen.go).
...
type Service interface {
	Devicestate(ctx context.Context, req *Request) (DevicestateResponseObject, error)
}
