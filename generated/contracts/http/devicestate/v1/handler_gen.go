...
// NewHandler creates a Handler for http.devicestate.v1.
...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	if visitErr := resp.visitDevicestateResponse(r.Context(), w); visitErr != nil {
