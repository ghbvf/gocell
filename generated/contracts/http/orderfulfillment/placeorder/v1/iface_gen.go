...
// Service is the business interface that the http.orderfulfillment.placeorder.v1 server cell must implement.
//
...
//     Placeorder{Status}{Suffix} structs (each implements
//     PlaceorderResponseObject declared in types_gen.go).
...
type Service interface {
	Placeorder(ctx context.Context, req *Request) (PlaceorderResponseObject, error)
}
