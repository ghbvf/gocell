...
// Service is the business interface that the http.orderfulfillment.orderstatus.v1 server cell must implement.
//
...
//     Orderstatus{Status}{Suffix} structs (each implements
//     OrderstatusResponseObject declared in types_gen.go).
...
type Service interface {
	Orderstatus(ctx context.Context, req *Request) (OrderstatusResponseObject, error)
}
