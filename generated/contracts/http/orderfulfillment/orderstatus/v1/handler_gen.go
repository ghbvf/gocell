...
var contractSpec = contractspec.ContractSpec{
	ID:        "http.orderfulfillment.orderstatus.v1",
...
// Handler wires HTTP decode/encode + auth.Mount for http.orderfulfillment.orderstatus.v1.
type Handler struct {
	svc Service
}

// NewHandler creates a Handler for http.orderfulfillment.orderstatus.v1.
...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.svc.Orderstatus(r.Context(), req)
	if err != nil {
	...
	if visitErr := resp.visitOrderstatusResponse(r.Context(), w); visitErr != nil {
