...
// Handler wires HTTP decode/encode + auth.Mount for http.deviceidentity.cacerts.v1.
type Handler struct {
	svc Service
}

// NewHandler creates a Handler for http.deviceidentity.cacerts.v1.
...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	req := &Request{}
	resp, err := h.svc.Cacerts(r.Context(), req)
	if err != nil {
	...
	if visitErr := resp.visitCacertsResponse(r.Context(), w); visitErr != nil {
