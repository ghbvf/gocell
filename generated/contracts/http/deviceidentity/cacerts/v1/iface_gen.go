...
// Service is the business interface that the http.deviceidentity.cacerts.v1 server cell must implement.
//
...
//     Cacerts{Status}{Suffix} structs (each implements
//     CacertsResponseObject declared in types_gen.go).
...
type Service interface {
	Cacerts(ctx context.Context, req *Request) (CacertsResponseObject, error)
}
