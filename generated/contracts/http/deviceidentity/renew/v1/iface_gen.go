...
// Service is the business interface that the http.deviceidentity.renew.v1 server cell must implement.
//
...
//     Renew{Status}{Suffix} structs (each implements
//     RenewResponseObject declared in types_gen.go).
...
type Service interface {
	Renew(ctx context.Context, req *Request) (RenewResponseObject, error)
}
