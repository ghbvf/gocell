...
var contractSpec = contractspec.ContractSpec{
	ID:        "http.devicecompliance.v1",
	Kind:      cellvocab.ContractHTTP,
	Transport: "http",
	Method:    "GET",
	Path:      "/api/v1/devicecompliance",
}

// Handler wires HTTP decode/encode + auth.Mount for http.devicecompliance.v1.
type Handler struct {
	svc    Service
	policy auth.Policy
}

// NewHandler creates a Handler for http.devicecompliance.v1.
...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.svc.Devicecompliance(r.Context(), req)
	if err != nil {
	...
	if visitErr := resp.visitDevicecomplianceResponse(r.Context(), w); visitErr != nil {
