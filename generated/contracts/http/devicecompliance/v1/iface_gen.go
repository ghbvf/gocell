...
// Service is the business interface that the http.devicecompliance.v1 server cell must implement.
//
...
//     Devicecompliance{Status}{Suffix} structs (each implements
//     DevicecomplianceResponseObject declared in types_gen.go).
...
type Service interface {
	Devicecompliance(ctx context.Context, req *Request) (DevicecomplianceResponseObject, error)
}
