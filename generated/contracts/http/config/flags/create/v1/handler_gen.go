...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	if resp == nil {
		...
		panic(errcode.Assertion("generated handler http.config.flags.create.v1: service returned nil response without error (typed envelope contract violation)"))
	}
	...
	if visitErr := resp.visitCreateResponse(r.Context(), w); visitErr != nil {
		slog.ErrorContext(r.Context(), "http.config.flags.create.v1: typed response visit failed",
