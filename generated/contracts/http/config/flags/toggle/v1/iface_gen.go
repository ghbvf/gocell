...
//     Toggle{Status}{Suffix} structs (each implements
//     ToggleResponseObject declared in types_gen.go).
...
type Service interface {
	Toggle(ctx context.Context, req *Request) (ToggleResponseObject, error)
}
