...
var requestSchemaJSON = []byte("{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"title\":\"http.config.flags.update.v1.request\",\"description\":\"PUT = full replacement. All three fields are required so callers cannot implicitly zero-write a field they did not intend to change. Use POST /{key}/toggle for the partial 'just flip enabled' workflow.\",\"type\":\"object\",\"properties\":{\"enabled\":{\"type\":\"boolean\"},\"rolloutPercentage\":{\"type\":\"integer\",\"minimum\":0,\"maximum\":100},\"description\":{\"type\":\"string\",\"minLength\":0,\"maxLength\":1024},\"expectedVersion\":{\"type\":\"integer\",\"minimum\":1,\"description\":\"Compare-and-swap guard. Must equal the flag's current version; mismatch returns 409 ERR_VERSION_CONFLICT.\"}},\"required\":[\"enabled\",\"rolloutPercentage\",\"description\",\"expectedVersion\"],\"additionalProperties\":false}")
