...
// Service is the business interface that the http.config.flags.update.v1 server cell must implement.
//
...
//     Update{Status}{Suffix} structs (each implements
//     UpdateResponseObject declared in types_gen.go).
...
type Service interface {
	Update(ctx context.Context, req *Request) (UpdateResponseObject, error)
}
