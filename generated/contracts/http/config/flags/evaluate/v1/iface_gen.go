...
//     Evaluate{Status}{Suffix} structs (each implements
//     EvaluateResponseObject declared in types_gen.go).
...
type Service interface {
	Evaluate(ctx context.Context, req *Request) (EvaluateResponseObject, error)
}
