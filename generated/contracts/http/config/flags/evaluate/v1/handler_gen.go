...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	if len(req.Subject) < 1 {
		httputil.WriteError(r.Context(), w, errcode.New(errcode.KindInvalid, errcode.ErrValidationFailed, "subject: value too short"))
		return
	}
	if len(req.Subject) > 256 {
		httputil.WriteError(r.Context(), w, errcode.New(errcode.KindInvalid, errcode.ErrValidationFailed, "subject: value too long"))
		return
	}
