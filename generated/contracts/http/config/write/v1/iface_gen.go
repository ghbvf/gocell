...
//     Write{Status}{Suffix} structs (each implements
//     WriteResponseObject declared in types_gen.go).
...
type Service interface {
	Write(ctx context.Context, req *Request) (WriteResponseObject, error)
}
