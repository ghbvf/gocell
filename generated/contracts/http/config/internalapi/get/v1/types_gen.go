...
// ResponseData is a generated DTO for contract http.config.internal.get.v1.
...
// http.config.internal.get.v1. Service.Get must return one of the
...
func (r Get200JSONResponse) visitGetResponse(ctx context.Context, w http.ResponseWriter) error {
	...
	if err := json.NewEncoder(w).Encode(Response(r)); err != nil {
		slog.ErrorContext(ctx, "http.config.internal.get.v1: encode Get200JSONResponse body", slog.Any("error", err))
		return err
	}
	return nil
}
