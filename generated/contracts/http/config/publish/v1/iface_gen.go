...
// Service is the business interface that the http.config.publish.v1 server cell must implement.
//
...
//     Publish{Status}{Suffix} structs (each implements
//     PublishResponseObject declared in types_gen.go).
...
type Service interface {
	Publish(ctx context.Context, req *Request) (PublishResponseObject, error)
}
