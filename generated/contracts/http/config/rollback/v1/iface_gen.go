...
//     Rollback{Status}{Suffix} structs (each implements
//     RollbackResponseObject declared in types_gen.go).
...
type Service interface {
	Rollback(ctx context.Context, req *Request) (RollbackResponseObject, error)
}
