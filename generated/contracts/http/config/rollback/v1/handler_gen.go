...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	if req.Version < 1 {
		httputil.WriteError(r.Context(), w, errcode.New(errcode.KindInvalid, errcode.ErrValidationFailed, "version: value below minimum"))
		return
	}
	if req.Version > 99999 {
		httputil.WriteError(r.Context(), w, errcode.New(errcode.KindInvalid, errcode.ErrValidationFailed, "version: value above maximum"))
		return
	}
