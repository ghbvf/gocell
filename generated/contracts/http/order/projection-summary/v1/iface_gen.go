...
// Service is the business interface that the http.order.projection-summary.v1 server cell must implement.
//
...
//     ProjectionSummary{Status}{Suffix} structs (each implements
//     ProjectionSummaryResponseObject declared in types_gen.go).
...
type Service interface {
	ProjectionSummary(ctx context.Context, req *Request) (ProjectionSummaryResponseObject, error)
}
