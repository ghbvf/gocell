...
// Service is the business interface that the http.order.confirm.v1 server cell must implement.
//
...
//     Confirm{Status}{Suffix} structs (each implements
//     ConfirmResponseObject declared in types_gen.go).
...
type Service interface {
	Confirm(ctx context.Context, req *Request) (ConfirmResponseObject, error)
}
