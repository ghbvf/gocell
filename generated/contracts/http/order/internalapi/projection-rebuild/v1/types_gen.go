...
// Request — http.order.internal.projection-rebuild.v1.request
type Request struct{}

// Response — http.order.internal.projection-rebuild.v1.response
type Response struct {
	Data *ResponseData `json:"data"`
}

// ResponseData is a generated DTO for contract http.order.internal.projection-rebuild.v1.
type ResponseData struct {
	EventsReplayed  int64 `json:"eventsReplayed"`
	StatusesRebuilt int64 `json:"statusesRebuilt"`
	LastAppliedSeq  int64 `json:"lastAppliedSeq"`
}

// ProjectionRebuildResponseObject is the typed response envelope for
// http.order.internal.projection-rebuild.v1. Service.ProjectionRebuild must return one of the
...
func (r ProjectionRebuild200JSONResponse) visitProjectionRebuildResponse(ctx context.Context, w http.ResponseWriter) error {
	...
	if err := json.NewEncoder(&buf).Encode(Response(r)); err != nil {
		...
		slog.ErrorContext(ctx, "http.order.internal.projection-rebuild.v1: encode ProjectionRebuild200JSONResponse body", attrs...)
		return err
	}
