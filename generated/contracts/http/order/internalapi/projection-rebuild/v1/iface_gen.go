...
// Service is the business interface that the http.order.internal.projection-rebuild.v1 server cell must implement.
//
...
//     ProjectionRebuild{Status}{Suffix} structs (each implements
//     ProjectionRebuildResponseObject declared in types_gen.go).
...
type Service interface {
	ProjectionRebuild(ctx context.Context, req *Request) (ProjectionRebuildResponseObject, error)
}
