...
func NewHandler(svc Service) *Handler {
	...
	if err != nil {
		panic(panicregister.Approved("http-device-register-v1-public-schema-compile-failed", errcode.Assertion("generated handler http.device.register.v1: schema compile failed: %v (codegen invariant violation; regenerate via gocell generate contract --all)", err)))
	}
