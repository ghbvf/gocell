...
//     Register{Status}{Suffix} structs (each implements
//     RegisterResponseObject declared in types_gen.go).
...
type Service interface {
	Register(ctx context.Context, req *Request) (RegisterResponseObject, error)
}
