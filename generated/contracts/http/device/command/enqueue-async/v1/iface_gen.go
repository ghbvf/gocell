...
// Service is the business interface that the http.device.command.enqueue-async.v1 server cell must implement.
//
...
//     EnqueueAsync{Status}{Suffix} structs (each implements
//     EnqueueAsyncResponseObject declared in types_gen.go).
...
type Service interface {
	EnqueueAsync(ctx context.Context, req *Request) (EnqueueAsyncResponseObject, error)
}
