...
//     ExtendLease{Status}{Suffix} structs (each implements
//     ExtendLeaseResponseObject declared in types_gen.go).
...
type Service interface {
	ExtendLease(ctx context.Context, req *Request) (ExtendLeaseResponseObject, error)
}
