...
//     Report{Status}{Suffix} structs (each implements
//     ReportResponseObject declared in types_gen.go).
...
type Service interface {
	Report(ctx context.Context, req *Request) (ReportResponseObject, error)
}
