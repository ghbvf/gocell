...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	if len(req.Reason) < 1 {
		httputil.WriteError(r.Context(), w, errcode.New(errcode.KindInvalid, errcode.ErrValidationFailed, "reason: value too short"))
		return
	}
	if len(req.Reason) > 32 {
		httputil.WriteError(r.Context(), w, errcode.New(errcode.KindInvalid, errcode.ErrValidationFailed, "reason: value too long"))
		return
	}
