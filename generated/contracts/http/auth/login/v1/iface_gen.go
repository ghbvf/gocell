...
//     Login{Status}{Suffix} structs (each implements
//     LoginResponseObject declared in types_gen.go).
...
type Service interface {
	Login(ctx context.Context, req *Request) (LoginResponseObject, error)
}
