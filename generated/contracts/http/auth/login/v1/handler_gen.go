...
func NewHandler(svc Service) *Handler {
	...
	if err != nil {
		panic(fmt.Sprintf("generated handler http.auth.login.v1: schema compile failed: %v (codegen invariant violation; regenerate via gocell generate contract --all)", err))
	}
