...
var requestSchemaJSON = []byte("{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"title\":\"http.auth.login.v1.request\",\"type\":\"object\",\"properties\":{\"username\":{\"type\":\"string\",\"minLength\":1,\"maxLength\":128},\"password\":{\"type\":\"string\",\"minLength\":8,\"maxLength\":72}},\"required\":[\"username\",\"password\"],\"additionalProperties\":false}")
...
func NewHandler(svc Service) *Handler {
	...
	if err != nil {
		panic(panicregister.Approved("http-auth-login-v1-schema-compile-failed", errcode.Assertion("generated handler http.auth.login.v1: schema compile failed: %v (codegen invariant violation; regenerate via gocell generate contract --all)", err)))
	}
...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	if visitErr := resp.visitLoginResponse(r.Context(), w); visitErr != nil {
