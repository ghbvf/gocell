...
var requestSchemaJSON = []byte("{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"title\":\"http.auth.user.create.v1.request\",\"type\":\"object\",\"properties\":{\"username\":{\"type\":\"string\",\"minLength\":1,\"maxLength\":128},\"email\":{\"type\":\"string\",\"minLength\":3,\"maxLength\":320},\"password\":{\"type\":\"string\",\"minLength\":8,\"maxLength\":72},\"requirePasswordReset\":{\"type\":\"boolean\"}},\"required\":[\"username\",\"email\",\"password\"],\"additionalProperties\":false}")

// Handler wires HTTP decode/encode + auth.Mount for http.auth.user.create.v1.
type Handler struct {
	svc              Service
	policy           auth.Policy
...
// NewHandler creates a Handler for http.auth.user.create.v1.
//
...
func NewHandler(svc Service, resolver authz.MethodPolicyResolver) *Handler {
	if resolver == nil {
		...
		panic(panicregister.Approved("http-auth-user-create-v1-resolver-nil", errcode.Assertion("generated handler http.auth.user.create.v1: resolver must not be nil (endpoints.http.permission contracts require the cell authz.MethodPolicyResolver; composition root must inject the cellgen-built resolver)")))
	}
