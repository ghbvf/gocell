...
// Service is the business interface that the http.auth.user.unlock.v1 server cell must implement.
//
...
//     Unlock{Status}{Suffix} structs (each implements
//     UnlockResponseObject declared in types_gen.go).
...
type Service interface {
	Unlock(ctx context.Context, req *Request) (UnlockResponseObject, error)
}
