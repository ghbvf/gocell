...
var requestSchemaJSON = []byte("{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"title\":\"http.auth.user.patch.v1.request\",\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\",\"minLength\":1,\"maxLength\":128},\"email\":{\"type\":\"string\",\"minLength\":3,\"maxLength\":320},\"status\":{\"type\":\"string\",\"minLength\":1,\"maxLength\":32},\"requirePasswordReset\":{\"type\":\"boolean\"}},\"additionalProperties\":false}")
...
func NewHandler(svc Service, resolver authz.MethodPolicyResolver) *Handler {
	if resolver == nil {
		...
		panic(panicregister.Approved("http-auth-user-patch-v1-resolver-nil", errcode.Assertion("generated handler http.auth.user.patch.v1: resolver must not be nil (endpoints.http.permission contracts require the cell authz.MethodPolicyResolver; composition root must inject the cellgen-built resolver)")))
	}
	...
	if err != nil {
		panic(panicregister.Approved("http-auth-user-patch-v1-standard-schema-compile-failed", errcode.Assertion("generated handler http.auth.user.patch.v1: schema compile failed: %v (codegen invariant violation; regenerate via gocell generate contract --all)", err)))
	}
...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	if visitErr := resp.visitPatchResponse(r.Context(), w); visitErr != nil {
