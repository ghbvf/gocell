...
//     ChangePassword{Status}{Suffix} structs (each implements
//     ChangePasswordResponseObject declared in types_gen.go).
...
type Service interface {
	ChangePassword(ctx context.Context, req *Request) (ChangePasswordResponseObject, error)
}
