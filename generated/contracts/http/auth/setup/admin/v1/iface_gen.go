...
//     Admin{Status}{Suffix} structs (each implements
//     AdminResponseObject declared in types_gen.go).
...
type Service interface {
	Admin(ctx context.Context, req *Request) (AdminResponseObject, error)
}
