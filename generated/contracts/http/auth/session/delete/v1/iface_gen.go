...
// Service is the business interface that the http.auth.session.delete.v1 server cell must implement.
//
...
//     Delete{Status}{Suffix} structs (each implements
//     DeleteResponseObject declared in types_gen.go).
...
type Service interface {
	Delete(ctx context.Context, req *Request) (DeleteResponseObject, error)
}
