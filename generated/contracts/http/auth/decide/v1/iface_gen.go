...
// Service is the business interface that the http.auth.decide.v1 server cell must implement.
//
...
//     Decide{Status}{Suffix} structs (each implements
//     DecideResponseObject declared in types_gen.go).
...
type Service interface {
	Decide(ctx context.Context, req *Request) (DecideResponseObject, error)
}
