...
// http.auth.role.list.v1. Service.List must return one of the
...
func (r List200JSONResponse) visitListResponse(ctx context.Context, w http.ResponseWriter) error {
	...
	if err := json.NewEncoder(w).Encode(Response(r)); err != nil {
		slog.ErrorContext(ctx, "http.auth.role.list.v1: encode List200JSONResponse body", slog.Any("error", err))
		return err
	}
	return nil
}
