...
//     Check{Status}{Suffix} structs (each implements
//     CheckResponseObject declared in types_gen.go).
...
type Service interface {
	Check(ctx context.Context, req *Request) (CheckResponseObject, error)
}
