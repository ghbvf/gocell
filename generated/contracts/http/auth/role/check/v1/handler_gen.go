...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	...
	}
	{
		...
		if len(v) < 1 {
			httputil.WriteError(r.Context(), w, errcode.New(errcode.KindInvalid, errcode.ErrValidationFailed, "roleName: value too short"))
			return
		}
		if len(v) > 256 {
			httputil.WriteError(r.Context(), w, errcode.New(errcode.KindInvalid, errcode.ErrValidationFailed, "roleName: value too long"))
			return
		}
		req.RoleName = v
	}
