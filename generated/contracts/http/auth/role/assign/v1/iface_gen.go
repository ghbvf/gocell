...
// Service is the business interface that the http.auth.role.assign.v1 server cell must implement.
//
...
//     Assign{Status}{Suffix} structs (each implements
//     AssignResponseObject declared in types_gen.go).
...
type Service interface {
	Assign(ctx context.Context, req *Request) (AssignResponseObject, error)
}
