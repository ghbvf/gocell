...
// Client is the sole sealed sibling-cell call type for http.auth.role.assign.v1 (ADR D2
...
// Assign dispatches POST /internal/v1/access/roles/assign through the sealed transport.
