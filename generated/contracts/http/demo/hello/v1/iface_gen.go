...
// Service is the business interface that the http.demo.hello.v1 server cell must implement.
//
...
//     Hello{Status}{Suffix} structs (each implements
//     HelloResponseObject declared in types_gen.go).
...
type Service interface {
	Hello(ctx context.Context, req *Request) (HelloResponseObject, error)
}
