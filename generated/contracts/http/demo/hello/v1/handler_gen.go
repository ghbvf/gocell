...
// Handler wires HTTP decode/encode + auth.Mount for http.demo.hello.v1.
type Handler struct {
	svc Service
}

// NewHandler creates a Handler for http.demo.hello.v1.
...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	req := &Request{}
	resp, err := h.svc.Hello(r.Context(), req)
	if err != nil {
	...
	if visitErr := resp.visitHelloResponse(r.Context(), w); visitErr != nil {
