...
// Service is the business interface that the http.admin.system.v1 server cell must implement.
//
...
//     System{Status}{Suffix} structs (each implements
//     SystemResponseObject declared in types_gen.go).
...
type Service interface {
	System(ctx context.Context, req *Request) (SystemResponseObject, error)
}
