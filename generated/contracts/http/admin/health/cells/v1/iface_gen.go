...
// Service is the business interface that the http.admin.health.cells.v1 server cell must implement.
//
...
//     Cells{Status}{Suffix} structs (each implements
//     CellsResponseObject declared in types_gen.go).
...
type Service interface {
	Cells(ctx context.Context, req *Request) (CellsResponseObject, error)
}
