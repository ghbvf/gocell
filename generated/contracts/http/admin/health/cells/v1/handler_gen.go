...
var contractSpec = contractspec.ContractSpec{
	ID:        "http.admin.health.cells.v1",
	Kind:      cellvocab.ContractHTTP,
	Transport: "http",
	Method:    "GET",
	Path:      "/api/v1/admin/health/cells",
}

// Handler wires HTTP decode/encode + auth.Mount for http.admin.health.cells.v1.
type Handler struct {
	svc    Service
	policy auth.Policy
}

// NewHandler creates a Handler for http.admin.health.cells.v1.
...
func (h *Handler) handle(w http.ResponseWriter, r *http.Request) {
	req := &Request{}
	resp, err := h.svc.Cells(r.Context(), req)
	if err != nil {
	...
	if visitErr := resp.visitCellsResponse(r.Context(), w); visitErr != nil {
