...
// Request — http.registry.contract.list.v1.request
type Request struct {
...
// http.registry.contract.list.v1. Service.List must return one of the
...
func (r List200JSONResponse) visitListResponse(ctx context.Context, w http.ResponseWriter) error {
	...
	if err := json.NewEncoder(&buf).Encode(Response(r)); err != nil {
		...
		slog.ErrorContext(ctx, "http.registry.contract.list.v1: encode List200JSONResponse body", attrs...)
		return err
	}
