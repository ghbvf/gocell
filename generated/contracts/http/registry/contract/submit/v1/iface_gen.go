...
// Service is the business interface that the http.registry.contract.submit.v1 server cell must implement.
//
...
//     Submit{Status}{Suffix} structs (each implements
//     SubmitResponseObject declared in types_gen.go).
...
type Service interface {
	Submit(ctx context.Context, req *Request) (SubmitResponseObject, error)
}
