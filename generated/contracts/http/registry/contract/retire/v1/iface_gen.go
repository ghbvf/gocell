...
// Service is the business interface that the http.registry.contract.retire.v1 server cell must implement.
//
...
//     Retire{Status}{Suffix} structs (each implements
//     RetireResponseObject declared in types_gen.go).
...
type Service interface {
	Retire(ctx context.Context, req *Request) (RetireResponseObject, error)
}
