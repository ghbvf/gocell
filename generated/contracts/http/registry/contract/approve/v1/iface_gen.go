...
// Service is the business interface that the http.registry.contract.approve.v1 server cell must implement.
//
...
//     Approve{Status}{Suffix} structs (each implements
//     ApproveResponseObject declared in types_gen.go).
...
type Service interface {
	Approve(ctx context.Context, req *Request) (ApproveResponseObject, error)
}
