...
// Service is the business interface that the http.registry.contract.reject.v1 server cell must implement.
//
...
//     Reject{Status}{Suffix} structs (each implements
//     RejectResponseObject declared in types_gen.go).
...
type Service interface {
	Reject(ctx context.Context, req *Request) (RejectResponseObject, error)
}
