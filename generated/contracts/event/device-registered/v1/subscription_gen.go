...
// Subscription is a mount-ready subscription for event.device-registered.v1.
...
// NewSubscription returns a mount-ready subscription for event.device-registered.v1.
