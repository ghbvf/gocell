...
// Subscription is a mount-ready subscription for event.config.entry-upserted.v1.
...
// NewSubscription returns a mount-ready subscription for event.config.entry-upserted.v1.
