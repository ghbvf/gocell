...
// consistencyLevel to L1, L2, L3, or L4 in examples/iotdevice/contracts/command/remotecommand/v1/contract.yaml.
const _ = uint(cellvocab.L4 - cellvocab.L1)

// Request — command.remotecommand.v1.request
type Request struct {
...
// Response — command.remotecommand.v1.response
type Response struct {
	Data *ResponseData `json:"data"`
}

// ResponseData is a generated DTO for contract command.remotecommand.v1.
