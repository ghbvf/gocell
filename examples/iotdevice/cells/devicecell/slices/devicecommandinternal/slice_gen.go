...
// Source: examples/iotdevice/cells/devicecell/slices/devicecommandinternal/slice.yaml
...
var sliceMeta = &metadata.SliceMeta{
	...
	Verify: metadata.SliceVerifyMeta{
		Unit: []string{
			"unit.devicecommandinternal.service",
		},
		Contract: []string{
	...
	AllowedFiles: []string{
		"examples/iotdevice/cells/devicecell/slices/devicecommandinternal/**",
	},
}
