...
var sliceMeta = &metadata.SliceMeta{
	...
	ContractUsages: []metadata.ContractUsage{
		{Contract: "event.order-created.v1", Role: "subscribe", Handler: "HandleOrderCreated", Projection: "order_status", OnReset: "ResetOrderStatus", ProjectionSource: "outbox"},
		{Contract: "event.order-status-changed.v1", Role: "subscribe", Handler: "HandleOrderStatusChanged", Projection: "order_transition", OnReset: "ResetOrderTransition", ProjectionSource: "outbox"},
