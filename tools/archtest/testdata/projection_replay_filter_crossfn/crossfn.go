...
// PROJECTION-REPLAY-PER-SPEC-FILTER-01: drainGap delegates to a helper
// (applyGated) that holds the applyOne call, so applyOne does NOT appear in
// drainGap's own AST subtree. The detector must therefore report
...
// drainGap delegates to applyGated — no direct applyOne call here.
