...
// STALE: this file only guards repo but not cache — intentionally out of sync
// with service.go for REQUIRED-DEP-NIL-GUARD-01 A1 fixture testing.
...
func (s *Service) validateRequired() error {
	if validation.IsNilInterface(s.repo) {
		return errcode.New(errcode.KindInternal, errcode.ErrCellInvalidConfig,
			"redstalegen.NewService: repo required")
	}
	return nil
}
