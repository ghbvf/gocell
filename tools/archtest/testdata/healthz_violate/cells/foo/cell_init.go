...
// from a hand-written file instead of using the typed funnels (cellgen
// RegisterRepoReady or kernel cell.RegisterEmitterHealthProbes).
//
...
func registerRepoReadyBad(reg cell.Registrar) error {
	...
	// use RegisterRepoReady / cell.RegisterEmitterHealthProbes instead.
