// Package reconcile is a RED blind-spot self-check fixture for
...
// newRenewTicker is an exempt controlPlaneClock method (sanctioned pair
// newRenewTicker→NewTicker). Its direct body call is exempt, but the closure it
// returns is NOT — closures inside an exempt method body are still flagged.
func (controlPlaneClock) newRenewTicker(interval time.Duration) func() {
