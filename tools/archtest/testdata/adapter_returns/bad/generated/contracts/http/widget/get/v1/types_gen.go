...
// Get999JSONResponse is an undeclared fictional status — the bad fixture returns
// this to simulate a contract violation.
type Get999JSONResponse struct{}

func (r Get999JSONResponse) visitGetResponse(w http.ResponseWriter) error { return nil }
