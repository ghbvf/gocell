// Package compliant is a fixture for archtest CLOCK-INJECTION-TEST-CALLSITE-01
// positive case: a test file calls NewService and correctly includes WithClock.
package compliant
...
func NewService(opts ...Option) *Service {
	...
	if s.clk == nil {
		panic("compliant.NewService: clock required — use WithClock(...)")
	}
	return s
}
