...
var adapterManagedResourceOptOut = map[string]string{
	...
	"adapters/mqtt.NoopPublisherCollector":        "stateless-collector: no-op observability sink, no owned lifecycle",
	"adapters/mqtt.NoopSubscriberCollector":       "stateless-collector: no-op observability sink, no owned lifecycle",
	"adapters/mqtt.PublishFailureReason":          "value-object: failure-reason enum",
	"adapters/mqtt.Publisher":                     "subresource-not-owner: uses caller-owned Connection",
	"adapters/mqtt.PublisherCollector":            "interface: observability collector contract, not a resource",
	"adapters/mqtt.PublisherOption":               "config: functional option",
	"adapters/mqtt.SubscribeFailureReason":        "value-object: failure-reason enum",
	"adapters/mqtt.Subscriber":                    "subresource-not-owner: uses caller-owned Connection",
	"adapters/mqtt.SubscriberCollector":           "interface: observability collector contract, not a resource",
	"adapters/mqtt.SubscriberConfig":              "config: construction input value",
	"adapters/mqtt.SubscriberOption":              "config: functional option",
	"adapters/mqtt.TopicNamespace":                "value-object: typed string topic namespace prefix",
	...
	"adapters/redis.HTTPIdempotencyStore":         "subresource-not-owner: uses caller-owned Redis Client",
	...
	"adapters/redis.RedisReconcileElector":        "subresource-not-owner: stateless facade over caller-owned Redis Client",
