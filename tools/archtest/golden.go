...
// is currently a review convention (Soft); upgrade path:
// FIXTURE-DIAGNOSTIC-GOLDEN-MIGRATION (optional Medium→Hard meta-archtest
// upgrade and scope B/C migration of the remaining wantLines-style fixture tests).
