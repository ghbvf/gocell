...
//
// SAGA-PROJECTION-DEPS-INMEM-FUNNEL-01 was merged later from the standalone
// sagaprojection_deps_inmem_funnel_test.go (#2175) — it had been added (#1391 /
// #2060) without consolidating, which TestSagaInvariantsConsolidated caught. Its
// importable scan logic lives in saga_invariants.go.
package archtest
...
// ============================================================================
// SAGA-PROJECTION-DEPS-INMEM-FUNNEL-01   (merged from sagaprojection_deps_inmem_funnel_test.go, #2175)
// ============================================================================
// INVARIANT: SAGA-PROJECTION-DEPS-INMEM-FUNNEL-01
//
// The importable scan logic (CheckSagaProjectionDepsInmemFunnel01 +
// scanSagaProjectionDepsInmemFunnel + consts) and the authoritative rule godoc
// live in saga_invariants.go. The tests below dogfood it against GoCell, prove
// the detector fires (RED fixture + synthetic-tree scan core), and close the
// dot-import blind spot.
