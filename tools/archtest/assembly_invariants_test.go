...
func loadKnownCellIDs(t *testing.T) []string {
	...
	// Match cells/<id>/cell.yaml only — exactly two slashes, "cells/" prefix.
	// A bare filepath.Base check would also match nested fixtures (e.g.
	// cells/<id>/sub/cell.yaml), letting future test scaffolding silently
	// inflate the cell ID set. Mirror the depth-2 pattern used below for
	// modules_gen.go.
