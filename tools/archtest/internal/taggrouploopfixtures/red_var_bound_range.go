...
// an *ast.Ident, not a CallExpr) with a typed-scope Run (Run(t, Typed(...), ...)) in the body.
// The rule must resolve the Ident's object back to the KnownNonDefaultTags binding and
