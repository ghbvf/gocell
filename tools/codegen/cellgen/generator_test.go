...
func TestRenderHealthzGen_HappyPath(t *testing.T) {
	...
	// File header marker (required by PROBENAME-SEALED-FUNNEL-01 cellgen-marker check + B10 archtest).
	mustContain(t, got, "// Code generated by gocell generate cell. DO NOT EDIT.")
...
// TestRenderCell_WithProjectionsAddsImportsAndRegisterProjection verifies that
// cell.tmpl emits the correct import alias line and reg.RegisterProjection(...)
// call when CellGenSpec contains one Projections entry. This proves the
// PROJECTION-REGISTER-FUNNEL-01 allowlist applies — the generated file carries
// the DO-NOT-EDIT banner, which is the marker that the archtest uses to identify
// generated files.
func TestRenderCell_WithProjectionsAddsImportsAndRegisterProjection(t *testing.T) {
	t.Parallel()
	spec := &CellGenSpec{
		Package: "demo", StructName: "Demo", CellID: "demo", ConsumerGroupDefault: "demo", RenderedMetaLiteral: "&metadata.CellMeta{}",
		Projections: []ProjectionGenSpec{{
			...
			ApplyExpr:    "c.proj.HandleOrderCreated",
			OnResetExpr:  "c.proj.ResetOrderStatus",
			SpecPackage:  "github.com/ghbvf/gocell/generated/contracts/event/order-created/v1",
			SpecAlias:    "proj0",
		}},
	}
	...
	// DO-NOT-EDIT banner proves PROJECTION-REGISTER-FUNNEL-01 allowlist applies.
	mustContain(t, got, "// Code generated by gocell generate cell. DO NOT EDIT.")

	// Import alias for the generated event contract package.
	mustContain(t, got, `proj0 "github.com/ghbvf/gocell/generated/contracts/event/order-created/v1"`)

	// RegisterProjection call: args are (applyExpr, projectionID, cellID, sliceID, onResetExpr).
	mustContain(t, got, `reg.RegisterProjection(proj0.NewProjectionRequest(`)
...
func TestRenderCell_ProjectionWithoutOnResetRendersNil(t *testing.T) {
	t.Parallel()
	spec := &CellGenSpec{
		Package: "demo", StructName: "Demo", CellID: "demo", ConsumerGroupDefault: "demo", RenderedMetaLiteral: "&metadata.CellMeta{}",
		Projections: []ProjectionGenSpec{{
	...
	// nil must appear as the 5th arg.
	mustContain(t, got, ", nil,")

	// The absent OnReset symbol must not appear anywhere.
	if strings.Contains(got, "ResetOrderStatus") {
		t.Errorf("OnResetExpr is empty but output contains ResetOrderStatus:\n%s", got)
	}
}

// TestRenderCell_SubscriptionAndProjectionCoexist verifies that subscribe and
// projection entries can coexist in one cell and both appear in the output with
// their distinct aliases (sub0 / proj0).
func TestRenderCell_SubscriptionAndProjectionCoexist(t *testing.T) {
	t.Parallel()
	spec := &CellGenSpec{
		Package: "demo", StructName: "Demo", CellID: "demo", ConsumerGroupDefault: "demo", RenderedMetaLiteral: "&metadata.CellMeta{}",
		Subscriptions: []SubscriptionGenSpec{{
	...
	// NewSubscription.Mount call.
	mustContain(t, got, `sub0.NewSubscription(`)
	mustContain(t, got, `.Mount(reg)`)

	// RegisterProjection call.
	mustContain(t, got, `reg.RegisterProjection(proj0.NewProjectionRequest(`)
}
