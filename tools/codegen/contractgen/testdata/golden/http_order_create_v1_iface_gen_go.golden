...
//     Create{Status}{Suffix} structs (each implements
//     CreateResponseObject declared in types_gen.go).
...
type Service interface {
	Create(ctx context.Context, req *Request) (CreateResponseObject, error)
}
