...
//
//	          | types_gen.go | iface_gen.go | handler_gen.go | spec_gen.go | subscription_gen.go | saga_gen.go
//	----------+--------------+--------------+----------------+-------------+---------------------+------------
//	http      |      ✔       |      ✔       |       ✔        |     —       |          —          |     —
//	event     |      ✔       |      ✔       |       —        |     ✔       |          ✔          |     —
//	command   |      ✔       |      ✔       |       —        |     —       |          —          |     —
...
// `Handle{Topic}(ctx, *Payload) error`. For kind=saga, iface_gen.go is
// intentionally empty (just the package clause) — the typed business interface
// is the Impl interface emitted in saga_gen.go, not a Service here.
//
