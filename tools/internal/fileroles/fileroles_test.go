...
func TestIsTestCodeAndIsProductionCode_Disjoint(t *testing.T) {
	...
	cases := []struct{ name, rel string }{
		...
		{"cells test", "corecells/accesscore/cell_test.go"},
		{"cells production", "corecells/accesscore/cell.go"},
		...
		{"auditcoretest helper", "corecells/auditcore/auditcoretest/canonical.go"},
		{"accesscoretest helper", "corecells/accesscore/accesscoretest/builders.go"},
...
func TestIsTestCode(t *testing.T) {
	...
	cases := []struct {
		...
		{"auditcoretest canonical", "corecells/auditcore/auditcoretest/canonical.go", true},
...
func TestIsProductionCode(t *testing.T) {
	...
	cases := []struct {
		...
		{"cells production", "corecells/accesscore/cell.go", true},
